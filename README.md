...
This means the `components/work/versions.md` file should be persisted somehow (e.g. in a Git Repository) to act as the baseline and keep the previous versions available for comparison.
